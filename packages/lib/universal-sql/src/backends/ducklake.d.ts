 ...
 * }} options
 */
export function createDuckLakeBuilder({ outputFilepath, localDataPath, remoteDataPath }: {
    outputFilepath: string;
    localDataPath: string;
    remoteDataPath: string;
}): Promise<{
 ...
 * }} options
 */
export function createDuckLakeBackend({ dataPath, urlPrefix, databaseFilename, ducklakeDataPath }: {
    dataPath: string;
    urlPrefix: string;
    databaseFilename?: string;
    ducklakeDataPath?: string;
 ...
 * }} options
 */
export function createDuckLakeBackendReader({ databaseFilePath, ducklakeDataPath }: {
    databaseFilePath: string;
    ducklakeDataPath?: string;
}): Promise<{
    name: string;
...
export function handleDuckLakeHmr({ sourceName, tableName, queueConnectionReload, warn }: {
    sourceName: string;
    tableName: string;
...
export function resolveDuckLakeRemoteUrlPrefix(urlPrefix: string): string;
export function resolveDuckLakeRemoteDataPath({
    dataPath,
    localDataPath,
    remoteUrlPrefix
}: {
