...
| `title` | string | Overrides the sidebar header text (otherwise your Evidence Studio organization name, or "Evidence"). |
| `favicon` | string | Overrides the default favicon. A path to an image file, relative to the project root, e.g. `./static/favicon.svg`. |
